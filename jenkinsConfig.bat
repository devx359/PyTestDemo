...
"C:/Program Files (x86)/Jenkins/workspace/pythonTest/venv/Scripts/python" -m pytest -v -s "C:/Program Files (x86)/Jenkins/workspace/pythonTest/Tests/Selenium/test_YT.py"
REM --alluredir="E:/PythonWorkspace/PyTestDemo/AllureReports"
